...
public class ScoreMasterTest {
	...
	[Test]
	public void TZ01SpareNotAStrike11(){
		int[] rolls = {0,10,1,1};
		int[] result = {11, 2};
		Assert.AreEqual(result.ToList(), ScoreMaster.ScoreFrames(rolls.ToList()));
	}

	[Test]
	public void TZ02ScoreBeforeLastBowl(){
		int[] rolls = { 10, 10, 10, 10, 9,0, 10, 10, 10, 10, 10,9};
		int[] totalS = {30, 60, 89,108, 117,147,177,207,236};
		Assert.AreEqual (totalS.ToList(), ScoreMaster.ScoreCumulative (rolls.ToList()));
	}
}